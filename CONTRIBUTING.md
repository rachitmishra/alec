...
```java
Picasso.with(context).load("https://www.practo.com/images/sexyjoe.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("https://www.practo.com/images/sexyjoe.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "https://www.practo.com/images/sexyjoe.jpg", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "https://www.practo.com/images/sexyjoe.jpg",
...
Original Content [Ribot](https://github.com/ribot/android-guidelines)
